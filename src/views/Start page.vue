        ...
        <mdb-card>
          <mdb-card-body class="mx-4">
            <div class="text-center">
              <h3 class="dark-grey-text mb-5"><strong>E-packing</strong></h3>
            </div>
            <div class="text-center mb-3">
              <mdb-btn type="button" gradient="blue" rounded class="btn-block z-depth-1a">Login</mdb-btn>
            </div>
            <div class="text-center mb-3">
          ...
          <h1 class="dark-grey-text mb-5">E-packing</h1>
          </mdb-modal-footer>
        </mdb-card>
      </mdb-col>
    </mdb-row>
